...
![dropdown](docs/features/dropdown_menu.png)

![dropdown mobile](docs/features/dropdown_menu_mobile.png)
...
![footer dark](docs/features/footer_dark.png)

<br>

![footer dark](docs/features/footer_light.png)
...
![home desktop](docs/features/home_desktop.png)
...
![products page 1](docs/features/products_page_1.png)
...
![product detail page ](docs/features/product_detail.png)
...
![product modal img ](docs/features/img_modal.png)
...
![add product ](docs/features/add_product.png)
...
![edit product ](docs/features/edit_product.png)
...
![shopping_bag ](docs/features/shopping_bag.png)
...
![checkout success ](docs/features/checkout_success.png)
...
![toasts ](docs/features/toasts.png)
...
![admin page](docs/features/django_admin.png)
...
![email ](docs/features/confirmation_email.png)
...
SQLite3 has been used as the database during development. However, since SQLite3 is intended only for development use, we will need to set up a new external database that can be accessed by Heroku for production deployment.

1. Go to the [ElephantSQL](https://www.elephantsql.com/) dashboard and click the create new instance button on the top right.
2. Name the plan (e.g. your project name), select tiny turtle plan (this is the free plan) and choose the region that is closest to you then click the review button.
